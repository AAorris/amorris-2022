  ...
  return (
    <div className={styles.app}>
      ...
      <section className={layoutStyles.topLevel}>
        ...
        <p>
          I have a wife and son (they&apos;re awesome) and the time I spend with
          them is my most precious.
          <br />
          Software is the superpower that slays busywork and unlocks time for
          what matters.
        </p>
        ...
        <p>
          ...
          connect.
          <br />
          If you&apos;re starting down the path into engineering, feel free to
          reach out for some free mentorship time.
          <br />
          Just seeing who I am? Maybe get a glimpse into my brain by browsing my{" "}
