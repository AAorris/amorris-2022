...
import image from "../../public/render.jpg";
      ...
      <section>
        <article>
          <p>
            ...
            acronym tag like this: ftw. You can define <del>deleted text</del>{" "}
            which often gets replaced with <ins>inserted</ins> text.
          </p>
          <p>
            ...
            quote tag lets you denote something as <q>quoted text</q>.
          </p>
        </article>
...
pre {
  ...
  line-height: 160%;
      ...
      <figure>
        <Image src={image} alt="render" width={400} />
        <figcaption>Fig1. A picture</figcaption>
      </figure>
      ...
      <section>
        <form>
          ...
          <fieldset>
            <legend>Example multiple select</legend>
          ...
          <fieldset>
            <legend>Example textarea</legend>
